...
# urls vari
nurls = ["http://spys.one/free-proxy-list/TH/", "https://www.proxynova.com/proxy-server-list/country-th/", "https://www.proxydocker.com/en/proxylist/country/Thailand","https://free-proxy-list.net/"]
...
def proxychecker(i):
	...
	try:
		urllib.request.urlopen(req, timeout=5)						# apre il sito
		print ("%s\033[1;92mSuccess!\033[1;37m\n\n" % proxy) # se funziona printa "it works"
		out_file.write(i)				# e lo scrive nel file.
	except:
		print ("%s \033[0;31mdoes not respond.\033[1;37m\n\n" % proxy) # altrimenti dice che non risponde
...
def main(): # funzione effettiva del programma.
	try:
		...
		print("\n")
		while True:
			choice = input("\nDo you want to check the proxy? [Y/n] > ") # scelta di quello che vuole l'utente
...
if __name__ == '__main__':
	...
	while True:
		choice = input("\nDo you want to download proxy? [Y/n] > ")
